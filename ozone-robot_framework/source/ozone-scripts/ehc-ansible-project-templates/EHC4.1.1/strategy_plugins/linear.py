...
class StrategyModule(StrategyBase):
    ...
    #     display.banner(" ################## Initializing linear Strategy Plugin ################## ")
        ...
        while work_to_do and not self._tqm._terminated:
            ...
            try:
                ...
                for (host, task) in host_tasks:
                    ...
                    if os.environ.get("OZONE_KILL_FLAG"):
                        print("!!!!!!!!!!!!!!!!! Ozone Kill Flag %s. Skipping !!!!!!!!!!!!!!!!! " % os.environ.get("OZONE_KILL_FLAG"))
                    ...
                    if task.action == 'meta':
                        ...
                        if not host_callback_sent:
                            self._tqm.send_callback('v2_playbook_on_host_task_start', host, task, is_conditional=False)
                            host_callback_sent = True
