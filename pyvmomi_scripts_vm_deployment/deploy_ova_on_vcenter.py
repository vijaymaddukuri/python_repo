#!/usr/bin/env python
"""
 Script to deploy VM via a single .ova and a single .vmdk file.
"""
...
def main():
    ...
    _resource_pool=get_resource_pool(si, 'xStreamHA')
    print(_resource_pool)
    spec_params = vim.OvfManager.CreateImportSpecParams()
    print(spec_params)
    import_spec = manager.CreateImportSpec(ovfd, _resource_pool, objs["datastore"], spec_params)
    print(objs["datacenter"].vmFolder)
    print(import_spec)
    lease = _resource_pool.ImportVApp(import_spec.importSpec,
...
# deploy_ova_on_vcenter.py -s '1.1.1.1' -u 'vj' '1.1.1.1'
args = get_args()
print(args.host)
