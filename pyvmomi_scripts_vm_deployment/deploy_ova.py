...
def main():
    ...
    propertyMappingDict = get_config('middle_ware_vm', 'properties', args.configpath)
    ...
    cisp = vim.OvfManager.CreateImportSpecParams(networkMapping=network_mappings, propertyMapping=mapping, entityName='middleware_vm', diskProvisioning='thin')
    print(cisp)
